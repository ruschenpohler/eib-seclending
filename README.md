...
This research output was produced using the [MEGA-CAS Platform](https://github.com/ruschenpohler/agent-ml-platform-wp) (Mechanistically Enforced Governance and Auditability-centered Content-Addressed-Storage Platform) for trustworthy human-agent research production.
